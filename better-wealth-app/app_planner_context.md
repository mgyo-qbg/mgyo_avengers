...
> 테스트 요청 시 반드시 `persona_spec.md`를 기본 참고 자료로 사용한다.
> 신규 기능/플로우에 맞게 페르소나 추가 또는 기존 페르소나 수정 후 해당 문서에 변경 이력을 기록한다.

- 페르소나 스펙 문서: `better-wealth-app/persona_spec.md`
- 테스트 결과 기록: `better-wealth-app/user_test_results.xlsx`

| 페르소나 | 특징 | 사용자 특성 축 |
|---------|------|--------------|
| P-A. 박은퇴 | 58세, 대기업 부장, 고연봉 28년 단일 경력 | 고자산·근로소득·금융정보 높음·은퇴 임박·DC 보유 |
| P-B. 이준비 | 45세, 중소기업 과장, 17년 근속 | 중자산·근로소득·금융정보 낮음·패시브 사용자 |
| P-C. 최자영 | 52세, 자영업자, 임대소득 보유 | 중자산·비근로소득·기타소득·조건부 UI 검증 |
| P-D. 정신입 | 34세, 스타트업 3년차, 자산 없음 | 자산없음·서비스 조건 미충족·조기 이탈·빈 상태 화면 |
| P-E. 한복잡 | 55세, 이직 경력자, 복합 자산 | 고자산·복합 경력·기타소득·금융정보 낮음·엣지 케이스 전체 |
