...
- P1: 설문 시작
- P3: 자산없음 경고
- P4~P13: 설문 입력 스텝 1/8~8/8 (연속형 프로그레스 바)
- P14~P16: 후처리 (약관동의, 전송 로딩, 전달 완료)

### 주요 제약사항 (Figma 코멘트 기준 — 파일: 0DVyXyoWEbXXNOZF0H92Ic)
- P4 은퇴시기: 55/60/65/70세 **셀렉트박스**, 디폴트 65세 (1/8)
- P5 기대수명: 현재나이+1~100세 **셀렉트박스**, 디폴트 100세 (2/8)
- P6 생활비: 324만원 디폴트 (통계청 2인 가구 기준) (3/8)
- P8 입력: **연소득**(세전/만원/디폴트없음), 납입종료 readonly(은퇴시기 연동) (5/8)
- P10 DC=Y 경로: IRP/DC 확인 후 P11 근로소득 **스킵** → P12 기타소득 직행 (6/8)
- P11 [병합] 근로소득자 Y/N + 연봉/근속연수: Y선택→입력 펼침 / N선택→입력 숨김 (6/8)
  - 연봉: 계산기 경로면 P8 연소득 자동, 직접입력 경로면 빈값
  - 서브헤더: "입력한 연봉과 근속연수를 바탕으로 퇴직금을 예상해 드려요."
  - 근속연수: 현재 재직 중인 회사 기준 만(滿) 연수
- P12 [병합] 기타소득 Y/N + 입력: Y선택→입력 펼침 / N선택→입력 숨김 (7/8)
  - 연소득(세전) **단일 입력** / 소득유형 미표시 / 시작시기=은퇴시기, 종료시기=기대수명 연동(readonly)
