...
flowchart TD
  ...
  MYDATA_YN -- Y --> P4[P4. 은퇴시기 입력 1/7]

  P4 --> P5[P5. 기대수명 입력 2/7]
  P5 --> P6[P6. 은퇴후 생활비 입력 3/7]

  P6 --> P7["P7. 국민연금 Y/N + 입력 [병합] 4/7<br/>네→월수령액 펼침 / 아니요→계산기+인라인결과"]

  P7 --> P8["P8. 근로소득자 Y/N + 연봉·근속연수 [병합] 5/7<br/>네→연봉/근속연수 펼침 / 아니요→바로 진행"]
  P8 --> P9["P9. 기타소득 Y/N + 연소득 입력 [병합] 6/7<br/>네→소득/시작/종료 펼침 / 아니요→바로 진행"]
  P9 --> P10[P10. 설문 결과확인 7/7]

  P10 --> TERMS_YN{T0054 약관동의?}
  TERMS_YN -- N --> P11[P11. T0054 약관동의]
  P11 --> P12
  TERMS_YN -- Y --> P12[P12. 설문결과 전송 로딩]
  P12 --> P13[P13. 설문 결과전달 완료]
  P13 --> HOME[베러웰스 홈]
```
...
| 2026-03-11 | P7+P8+P9 병합 → 단일 P7 (국민연금 Y/N + 직접입력 또는 계산기 + 인라인 결과), P10(IRP/DC 자산 확인) 제거 → DC 분기 완전 삭제, P11→P8, P12→P9, P13→P10, P14→P11, P15→P12, P16→P13, 총 12개 페이지 (P1·P3~P13), step 7단계 완전 직선 플로우 |
